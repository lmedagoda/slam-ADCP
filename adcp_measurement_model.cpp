...
ADCP_measurement_model::ADCP_measurement_model( const unsigned short cell_start_,
    ...
    cell_start(cell_start_), depth_cell_size(depth_cell_size_), blank_d(blank_d_), vert_grid_size(vert_grid_size_), hori_res(hori_res_), X_EKF(X_EKF_),
    max_states(max_states_), num_other_states(num_other_states_), position(position_), velocity(velocity_), euler(euler_)
{
