...
{
public:
    ADCP_measurement_model(const unsigned short cell_start_,
...
private:
    ...
    const boost::array<double,200>& X_EKF; // make sure you get the referencing right. All references are from the first ADCP state
